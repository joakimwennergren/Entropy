        ...
        namespace Pipelines
        {
            ...
            private:
                std::vector<VkDescriptorSetLayout> Setup()
                {
                    ...
                    std::vector<VkDescriptorSetLayoutBinding> bindings1 = {samplerLayoutBinding1};

                    auto descriptorSetLayout1 = std::make_shared<DescriptorsetLayout>(_logicalDevice, bindings1);
