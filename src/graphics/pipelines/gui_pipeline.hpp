        ...
        namespace Pipelines
        {
            ...
            private:
                std::vector<VkDescriptorSetLayout> Setup()
                {
                    ...
                    std::vector<VkDescriptorSetLayoutBinding> textureBinding = {samplerLayoutBinding1};

                    auto descriptorSetLayout0 = std::make_shared<DescriptorsetLayout>(_logicalDevice, textureBinding);
