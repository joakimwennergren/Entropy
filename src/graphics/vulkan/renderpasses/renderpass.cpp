 ...
 */
uint32_t RenderPass::findMemoryType(uint32_t typeFilter,
...
void RenderPass::RecreateDepthBuffer() {
  ...
  */
  ...
  CreateImage(_swapChain->swapChainExtent.width,
              _swapChain->swapChainExtent.height, depthFormat,
              VK_IMAGE_TILING_OPTIMAL,
              VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT);

  depthImageView = ImageView(_logicalDevice->Get(), _depthImage, depthFormat,
