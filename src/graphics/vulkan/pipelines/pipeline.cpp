...
Pipeline::Pipeline(VulkanBackend vbe, RenderPass rp, Swapchain sc, DescriptorPool dp, DescriptorSetLayoutFactory dslf, DescriptorSetFactory dsf) 
{
    _vulkanBackend = &vbe;
    _renderPass = &rp;
    _swapChain = &sc;
...
void Pipeline::Build(Shader vertShader, Shader fragShader, std::vector<VkDescriptorSetLayout> dsLayouts) 
{     
    VkPipelineShaderStageCreateInfo vertShaderStageInfo{};
    vertShaderStageInfo.sType =
        VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
    vertShaderStageInfo.module = vertShader.GetVertShaderModule();
    ...
    fragShaderStageInfo.module = fragShader.GetFragShaderModule();
    ...
    if (vkCreatePipelineLayout(_vulkanBackend->logicalDevice.Get(), &pipelineLayoutInfo, nullptr,
    ...
    if (vkCreateGraphicsPipelines(_vulkanBackend->logicalDevice.Get(), VK_NULL_HANDLE, 1,
...
//                      std::vector<VkDescriptorSetLayout> dsLayout,
