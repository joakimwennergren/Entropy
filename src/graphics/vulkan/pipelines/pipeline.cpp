...
void Pipeline::Setup(std::unique_ptr<Shader> shader,
  ...
  if (vkCreatePipelineLayout(_logicalDevice->Get(), &pipelinelayout, nullptr,
  ...
  if (vkCreateGraphicsPipelines(_logicalDevice->Get(), VK_NULL_HANDLE, 1,
