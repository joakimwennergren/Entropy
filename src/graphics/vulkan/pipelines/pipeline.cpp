...
void Pipeline::Build(std::shared_ptr<Shader> shader,
  ...
  if (vkCreateGraphicsPipelines(_logicalDevice->Get(), _pipelineCache->Get(), 1,
...
// //   auto shader =
// //       std::make_unique<Shader>(_serviceLocator, GetShadersDir() +
// vertexShader,
// //                                GetShadersDir() + fragmentShader);
// //   Setup(std::move(shader), dsLayout, depthWrite, depthBounds,
// pipelinelayout,
// //         polygonMode);
// }
