...
struct SwapChainTexture : public BaseTexture {
  SwapChainTexture(unsigned int width, unsigned int height) {
    ...
    VkResult res =
        vmaCreateImage(allocator->Get(), &imageInfo, &allocCreateInfo,
