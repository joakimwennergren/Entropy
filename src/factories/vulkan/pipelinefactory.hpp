...
struct PipelineFactory {
  ...
  PipelineFactory(VulkanBackend backend, RenderPass renderPass, Swapchain swapchain, DescriptorPool descriptorPool, DescriptorSetLayoutFactory dslf, DescriptorSetFactory dsf) 
  : _vkBackend{backend}, 
  ...
  {
    return StaticPipeline(_vkBackend, _renderPass, _swapChain, _descriptorPool, _descriptorSetLayoutFactory, _descriptorSetFactory);
  }
