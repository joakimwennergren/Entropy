...
//   //                        sol::environment(_lua, sol::create,
//   _lua.globals());
...
//           // auto e =
//           _serviceLocator->GetService<World>()->gameWorld.entity();
...
//           // model->getSceneDimensions();
//           // e.set<Entropy::Components::BoxCollisionShape3D>(
//           //     {glm::vec3{model->dimensions.max.x, model->dimensions.max.y
//           / 2.0,
//           //                model->dimensions.max.z},
//           //      glm::vec3{0.0, 0.0 - (model->dimensions.max.y / 2.0),
//           0.0}});
//           // e.set<Entropy::Components::RigidBody3D>({});
//           // e.set<Entropy::Components::Scripted>({});
...
//   _lua["RunAnimation"] = [](std::optional<flecs::entity> optional, float
//   tick) {
