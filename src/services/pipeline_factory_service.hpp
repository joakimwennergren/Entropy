...
struct PipelineFactoryService
    : kgr::single_service<PipelineFactory, kgr::dependency<VulkanBackendService, RenderPassService, SwapchainService, DescriptorPoolService, DescriptorSetLayoutFactoryService, DescriptorSetFactoryService>> {};
